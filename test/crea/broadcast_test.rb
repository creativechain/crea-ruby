...
module Crea
  class BroadcastTest < Crea::Test
    ...
    def setup
      ...
      if app_base
        @database_api = Crea::DatabaseApi.new(url: TEST_NODE)
        @block_api = Crea::BlockApi.new(url: TEST_NODE)
        @network_broadcast_api = Crea::NetworkBroadcastApi.new(url: TEST_NODE)
      else
        @database_api = @block_api = @network_broadcast_api = Crea::CondenserApi.new(url: TEST_NODE)
      end
    ...
    # we know it works:
    # https://cread.com/tx/1ab30d6fef305121ee82e53b04605a641a79459d
    ...
    def test_comment_both_metadata
      ...
      assert_raises Crea::ArgumentError do
      ...
      options = {
        params: {
          ...
          props: {
            ...
            cbd_exchange_rate: {base: '1.000 CBD', quote: '1.000 CREA'},
    ...
    def test_custom_json
      options = {
        params: {
          ...
          id: 'follow',
          json: '["follow",{"follower":"creary","following":"alice","what":["blog"]}]'
        }
      }
    ...
    def test_custom_json_both_data
      options = {
        params: {
          ...
          required_posting_auths: [@account_name],
          id: 'follow',
          data: ["follow",{"follower":"creary","following":"alice","what":["blog"]}],
          json: '["follow",{"follower":"creary","following":"alice","what":["blog"]}]'
        }
      }
    ...
    def test_fake_op
      ...
      vcr_cassette('broadcast_fake_op') do
        assert_raises UnknownOperationError do
          Crea::Broadcast.process(@broadcast_options.merge(options))
        end
      end
    end
    ...
    def test_random_op
      fields = %i(account account_to_recover active agent allow_curation_rewards
        ...
        requestid required_auths required_posting_auths cbd_amount crea_amount
