...
module Crea
  # :nocov:
  class AccountHistoryApiTest < Crea::Test
    def setup
      @api = Crea::AccountHistoryApi.new(url: TEST_NODE)
    ...
    def test_api_class_name
      assert_equal 'AccountHistoryApi', Crea::AccountHistoryApi::api_class_name
    end
    
    def test_inspect
      assert_equal "#<AccountHistoryApi [@chain=crea, @methods=<3 elements>]>", @api.inspect
    end
