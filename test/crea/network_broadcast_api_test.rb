...
module Crea
  class NetworkBroadcastApiTest < Crea::Test
    def setup
      @api = Crea::NetworkBroadcastApi.new(url: TEST_NODE)
      @jsonrpc = Jsonrpc.new(url: TEST_NODE)
      @methods = @jsonrpc.get_api_methods[@api.class.api_name]
    end
    def test_api_class_name
      assert_equal 'NetworkBroadcastApi', Crea::NetworkBroadcastApi::api_class_name
    end
    
    def test_inspect
      assert_equal "#<NetworkBroadcastApi [@chain=crea, @methods=<2 elements>]>", @api.inspect
    end
