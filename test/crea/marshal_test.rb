...
module Crea
  class MarshalTest < Crea::Test
    include Utils
    def setup
      @database_api = Crea::DatabaseApi.new
    end
    ...
    def test_trx_example_1
      ...
      assert_equal Type::Amount.new('19.477 CBD').to_s, marshal.amount.to_s, 'expect amount_to_sell: 19.477 CBD'
      assert_equal Type::Amount.new('67.164 CREA').to_s, marshal.amount.to_s, 'expect min_to_receive: 67.164 CREA'
    ...
    def test_trx_example_2
        ...
        "operations": [
          {
            ...
            "value": {
              ...
              "reward_crea": {"amount": "0", "precision": 3, "nai": "@@000000021"},
              "reward_cbd": {"amount": "845", "precision": 3, "nai": "@@000000013"},
      ...
      assert_equal Type::Amount.new('0.000 CREA').to_s, marshal.amount.to_s, 'expect amount: 0.000 CREA'
      assert_equal Type::Amount.new('0.845 CBD').to_s, marshal.amount.to_s, 'expect amount: 0.845 CBD'
    ...
    def test_trx_ad_hoc_1
      ...
      builder.put(account_update_operation: {
        account: 'social',
        memo_key: 'CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG',
        json_metadata: '{}'
      })
      ...
      assert 0, marshal.authority(optional: true)
      assert 0, marshal.authority(optional: true)
      assert_equal 'CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG', marshal.public_key, 'expect memo_key: CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG'
    ...
    def test_trx_ad_hoc_2
      ...
      builder.put(comment_operation: {
        ...
        "body": "[![Thumbnail](https:\/\/images.dlive.io\/4a85e837-9e18-11e8-9a43-0242ac110002)](https:\/\/dlive.io\/video\/zaku\/98bb0d05-9e15-11e8-b733-0242ac110003)\n\n\n# MC5: MODERN COMBAT 5 Videos Upload:\n\n![flower-squiggle-2s.png](https:\/\/cdn.crearyimages.com\/DQmcFuQRq8xwnjitZ1VPK7JvyCjAP6DJ1W4xqUSdvAugWiV\/flower-squiggle-2s.png)\n\n* [MODERN COMBAT 5 (BLACKOUT) : Multiplayer Fight + COMBAT PACK Unlock + Level up to 5](https:\/\/creary.net\/games\/@zaku\/modern-combat-5-blackout-multiplayer-fight-combat-pack-unlock-level-up-to-5)\n\n* [MODERN COMBAT 5 (BLACK OUT) : Multiplayer Fight ( Free-For-All + VIP ) + Reward Redeem + GOLDEN BOSK Purchase](https:\/\/creary.net\/dlive\/@zaku\/768946c6-98a6-11e8-8af8-0242ac110003)\n\n* [MODERN COMBAT GAMEPLAY : Multiplayer fights](https:\/\/dlive.io\/video\/zaku\/c2fb655a-9a5c-11e8-9e1e-0242ac110003)\n\n* [MODERN COMBAT 5 (BLACK OUT) : Multiplayer Fight ( Free-For-All + VIP ) + Reward Redeem + GOLDEN BOSK Purchase](https:\/\/creary.net\/dlive\/@zaku\/768946c6-98a6-11e8-8af8-0242ac110003)\n\n* [MODERN COMBAT GAMEPLAY : Multiplayer fights](https:\/\/creary.net\/dlive\/@zaku\/c2fb655a-9a5c-11e8-9e1e-0242ac110003)\n\n* [MODERN COMBAT 5 [BLACK OUT] : GAMEPLAY #08-Aug-2018](https:\/\/creary.net\/dlive\/@zaku\/8fb4c940-9bb9-11e8-9a98-0242ac110003)\n\n# MODERN COMBAT VERSUS Videos Upload:\n\n![flower-squiggle-2s.png](https:\/\/cdn.crearyimages.com\/DQmcFuQRq8xwnjitZ1VPK7JvyCjAP6DJ1W4x
:\/\/www.youtube.com\/user\/GameRiotArmy)\n\n<sub>***INFORMATION TAKEN FROM MC5 WEBSITE***<\/sub>\n\n[![zakucustomfooter2.gif](https:\/\/cdn.crearyimages.com\/DQmcdJWyg3fYukURPqrwb4nqoRPvEQVd6d1RqkUopxTtBPR\/zakucustomfooter2.gif)](https:\/\/discord.gg\/Z3P6bbt)<\/center>\n\n\nMy video is at [DLive](https:\/\/dlive.io\/video\/zaku\/98bb0d05-9e15-11e8-b733-0242ac110003)",
        "json_metadata": "{\"tags\":[\"dlive\",\"dlive-video\",\"Gaming\",\"creagamingcommunity\",\"games\",\"dailygames\",\"mc5\",\"moderncombat5blackout\"],\"app\":\"dlive\/0.1\",\"format\":\"markdown\",\"language\":\"English\",\"thumbnail\":\"https:\/\/images.dlive.io\/4a85e837-9e18-11e8-9a43-0242ac110002\"}"
      })
      ...
      assert_equal "{\"tags\":[\"dlive\",\"dlive-video\",\"Gaming\",\"creagamingcommunity\",\"games\",\"dailygames\",\"mc5\",\"moderncombat5blackout\"],\"app\":\"dlive\/0.1\",\"format\":\"markdown\",\"language\":\"English\",\"thumbnail\":\"https:\/\/images.dlive.io\/4a85e837-9e18-11e8-9a43-0242ac110002\"}", marshal.string, 'expect json_metadata: {...}'
    end
    ...
    def test_trx_ad_hoc_3
      ...
      builder.put(account_update_operation: {
        ...
        owner: {
          weight_threshold: 1,
          account_auths: [],
          key_auths: [['CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG', 1]],
        },
        active: {
          weight_threshold: 1,
          account_auths: [],
      ...
      marshal.authority(optional: true).tap do |owner|
        ...
        assert_equal [["CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG", 1]], owner[:key_auths], 'expect owner authority key_auths: [["CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG", 1]]'
      end
      ...
      marshal.authority(optional: true).tap do |active|
        ...
        assert_equal [["CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG", 1]], active[:key_auths], 'expect active authority key_auths: [["CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG", 1]]'
      end
      ...
      marshal.authority(optional: true).tap do |posting|
        ...
        assert_equal [["CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG", 1]], posting[:key_auths], 'expect posting authority key_auths: [["CREA8ZSyzjPm48GmUuMSRufkVYkwYbZzbxeMysAVp7KFQwbTf98TcG", 1]]'
      end
    ...
    def test_trx_ad_hoc_4
      ...
      builder.put(escrow_transfer: { # FIXME Why do we have to use escrow_transfer and not :escrow_transfer_operation here?
        ...
        agent: 'bob',
        escrow_id: 1234,
        cbd_amount: '0.000 CBD',
        crea_amount: '0.000 CREA',
        fee: '0.000 CREA',
      ...
      assert_equal '0.000 CBD', marshal.amount.to_s, 'expect cbd_amount: 0.000 CBD'
      assert_equal '0.000 CREA', marshal.amount.to_s, 'expect crea_amount: 0.000 CREA'
      assert_equal 1234, marshal.uint32, 'expect escrow_id: 1234'
      assert_equal 'bob', marshal.string, 'expect agent: bob'
      assert_equal '0.000 CREA', marshal.amount.to_s, 'expect fee: 0.000 CREA'
    ...
    def test_trx_ad_hoc_6
      ...
      assert_equal 'alice', marshal.string, 'expect author: alice'
      assert_equal 'permlink', marshal.string, 'expect permlink: permlink'
      assert_equal '1000000.000 CBD', marshal.amount.to_s, 'expect max_accepted_payout: 1000000.000 CBD'
      assert_equal 10000, marshal.uint16, 'expect percent_crea_dollars: 10000'
