...
module Crea
  class RcApiTest < Crea::Test
    def setup
      @api = Crea::RcApi.new(url: TEST_NODE)
      @jsonrpc = Jsonrpc.new(url: TEST_NODE)
      @methods = @jsonrpc.get_api_methods[@api.class.api_name]
    end
    
    def test_api_class_name
      assert_equal 'RcApi', Crea::RcApi::api_class_name
    end
    
    def test_inspect
      assert_equal "#<RcApi [@chain=crea, @methods=<3 elements>]>", @api.inspect
    end
