...
module Crea
  class StreamTest < Crea::Test
    def setup
      @stream = Crea::Stream.new(url: TEST_NODE, no_warn: true)
    ...
    def test_block_headers_mode_head
      stream = Crea::Stream.new(url: TEST_NODE, mode: :head)
      options = {
    ...
    def test_block_headers_mode_bogus
      stream = Crea::Stream.new(url: TEST_NODE, mode: :WRONG)
      options = {
        until_block_num: @head_block_num + 1
      }
