...
module Crea
  class TransactionBuilderTest < Crea::Test
    include ChainConfig
    ...
    def test_transaction_builder_initialize_bad_mainnet_injection
      options = {
        ...
        block_api: :bogus_api,
        testnet: true,
        chain_id: NETWORKS_CREA_CHAIN_ID
      }
      assert_raises UnsupportedChainError do
        TransactionBuilder.new(@options.merge options)
      end
    ...
    # Just like: https://github.com/creary/crea-js/blob/1a0f872b81399cd98c1a86bed2f67e7cf8a279da/examples/multisig.js
