...
module Crea
  class DatabaseApiTest < Crea::Test
    include Utils
    
    def setup
      @api = Crea::DatabaseApi.new(url: TEST_NODE)
      @jsonrpc = Jsonrpc.new(url: TEST_NODE)
      @methods = @jsonrpc.get_api_methods[@api.class.api_name]
    end
    def test_api_class_name
      assert_equal 'DatabaseApi', Crea::DatabaseApi::api_class_name
    end
    
    def test_inspect
      assert_equal "#<DatabaseApi [@chain=crea, @methods=<47 elements>]>", @api.inspect
    end
    ...
    def test_find_account_recovery_requests
      vcr_cassette('database_api_find_account_recovery_requests', record: :once) do
        @api.find_account_recovery_requests(accounts: ['creary']) do |result|
    ...
    def test_find_accounts
      vcr_cassette('database_api_find_accounts', record: :once) do
        @api.find_accounts(accounts: ['creary']) do |result|
    ...
    def test_find_change_recovery_account_requests
      vcr_cassette('database_api_find_change_recovery_account_requests', record: :once) do
        @api.find_change_recovery_account_requests(accounts: ['creary']) do |result|
          assert_equal Hashie::Array, result.requests.class
        end
      end
    end
    ...
    def test_find_comments
      vcr_cassette('database_api_find_comments', record: :once) do
        @api.find_comments(comments: [['creary', 'firstpost']]) do |result|
    ...
    def test_find_decline_voting_rights_requests
      vcr_cassette('database_api_find_decline_voting_rights_requests', record: :once) do
        @api.find_decline_voting_rights_requests(accounts: ['creary']) do |result|
          assert_equal Hashie::Array, result.requests.class
        end
      end
    end
    ...
    def test_find_escrows
      vcr_cassette('database_api_find_escrows', record: :once) do
        @api.find_escrows(from: 'creary') do |result|
    ...
    def test_find_limit_orders
      vcr_cassette('database_api_find_limit_orders', record: :once) do
        @api.find_limit_orders(account: 'creary') do |result|
    ...
    def test_find_owner_histories
      vcr_cassette('database_api_find_owner_histories', record: :once) do
        @api.find_owner_histories(owner: 'creary') do |result|
    ...
    def test_find_savings_withdrawals
      vcr_cassette('database_api_find_savings_withdrawals', record: :once) do
        @api.find_savings_withdrawals(account: 'creary') do |result|
          assert_equal Hashie::Array, result.withdrawals.class
        end
      end
    end
    
    def test_find_cbd_conversion_requests
      vcr_cassette('database_api_find_cbd_conversion_requests', record: :once) do
        @api.find_cbd_conversion_requests(account: 'creary') do |result|
          assert_equal Hashie::Array, result.requests.class
        end
      end
    end
    ...
    def test_find_vesting_delegation_expirations
      vcr_cassette('database_api_find_vesting_delegation_expirations', record: :once) do
        @api.find_vesting_delegation_expirations(account: 'creary') do |result|
    ...
    def test_find_vesting_delegations
      vcr_cassette('database_api_find_vesting_delegations', record: :once) do
        @api.find_vesting_delegations(account: 'creary') do |result|
          assert_equal Hashie::Array, result.delegations.class
        end
      end
    end
    ...
    def test_find_votes
      vcr_cassette('database_api_find_votes', record: :once) do
        @api.find_votes(author: 'creary', permlink: 'firstpost') do |result|
    ...
    def test_find_withdraw_vesting_routes
      vcr_cassette('database_api_find_withdraw_vesting_routes', record: :once) do
        ...
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L607
        options = {
          account: 'creary',
    ...
    def test_find_witnesses
      vcr_cassette('database_api_find_witnesses', record: :once) do
        @api.find_witnesses(owners: ['creary']) do |result|
    ...
    def test_get_transaction_hex_account_create
      vcr_cassette('database_api_get_transaction_hex_account_create', record: :once) do
        trx = {
          ...
          operations: [{
            type: :account_create_operation, value: {
              fee: {amount: '0', precision: 3, nai: '@@000000021'}, # 0.000 CREA
              creator: "initminer",
              new_account_name: "scott",
              owner: {
                weight_threshold: 1,
                account_auths: [],
                key_auths: [["CREA7DTS62msowgpAZJBNRMStMUt5bfRA4hc9j5wjwU4vKhi3KFkKb", 1]]
              },
              active: {
                weight_threshold: 1,
                account_auths: [],
                key_auths: [["CREA8k1f8fvHxLrCTqMdRUJcK2rCE3y7SQBb8PremyadWvVWMeedZy", 1]]
              },
              posting: {
                weight_threshold: 1,
                account_auths: [],
                key_auths: [["CREA6DgpKJqoVGg7o6J1jdiP45xxbgoUg5VGzs96YBxX42NZu2bZea", 1]]
              },
              memo_key: "CREA6ppNVEFmvBW4jEkzxXnGKuKuwYjMUrhz2WX1kHeGSchGdWJEDQ",
              json_metadata: ""
            }
          }],
          extensions: [],
        ...
        @api.get_transaction_hex(trx: trx) do |result|
          ...
          assert result.hex.include?('535445454d'), 'expect hex to include "CREA"'
    ...
    def test_list_account_recovery_requests
      vcr_cassette('database_api_list_account_recovery_requests', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L406
        options = {
          start: nil,
          limit: 0,
          order: 'by_account'
    ...
    def test_list_accounts
      vcr_cassette('database_api_list_accounts', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L307
        options = {
          start: nil,
          limit: 0,
          order: 'by_name'
    ...
    def test_list_change_recovery_account_requests
      vcr_cassette('database_api_list_change_recovery_account_requests', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L460
        options = {
          start: nil,
          limit: 0,
          order: 'by_account'
    ...
    def test_list_comments
      vcr_cassette('database_api_list_comments', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L941
        options = {
          start: ['2016-03-24T16:00:00', 'creary', 'firstpost'],
          limit: 0,
    ...
    def test_list_decline_voting_rights_requests
      vcr_cassette('database_api_list_decline_voting_rights_requests', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L867
        options = {
          start: nil,
          limit: 0,
          order: 'by_account'
    ...
    def test_list_escrows
      vcr_cassette('database_api_list_escrows', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L515
        options = {
          start: ['creary'],
          limit: 0,
          order: 'by_from_id'
    ...
    def test_list_limit_orders
      vcr_cassette('database_api_list_limit_orders', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L1278
        options = {
          start: [],
          limit: 0,
          order: 'by_price'
    ...
    def test_list_cbd_conversion_requests
      vcr_cassette('database_api_list_cbd_conversion_requests', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L814
        options = {
          start: [],
          limit: 0,
        ...
        @api.list_cbd_conversion_requests(options) do |result|
          assert_equal Hashie::Array, result.requests.class
        end
      end
    end
    ...
    def test_list_vesting_delegation_expirations
      vcr_cassette('database_api_list_vesting_delegation_expirations', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L759
        options = {
          start: [],
          limit: 0,
          order: 'by_expiration'
    ...
    def test_list_vesting_delegations
      vcr_cassette('database_api_list_vesting_delegations', record: :once) do
        ...
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L705
        options = {
          start: [],
          limit: 0,
          order: 'by_delegation'
    ...
    def test_list_votes
      vcr_cassette('database_api_list_votes', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L1125
        options = {
          start: [nil, nil, nil],
          limit: 0,
    ...
    def test_list_witness_votes
      vcr_cassette('database_api_list_witness_votes', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L252
        options = {
          start: [],
          limit: 0,
    ...
    def test_list_witnesses
      vcr_cassette('database_api_list_witnesses', record: :once) do
        # Other order types are listed here:
        # https://github.com/creary/crea/blob/1cfdf8101ec415156b155c9ec90b0a4d439a039f/libraries/plugins/apis/database_api/database_api.cpp#L188
        options = {
          start: 'creary',
          limit: 0,
          order: 'by_name'
    ...
    def test_verify_account_authority
      vcr_cassette('database_api_verify_account_authority', record: :once) do
        @api.get_config do |config|
          prefix = config.CREA_ADDRESS_PREFIX
          options = {
            account: 'creary',
    ...
    def test_computed_trx_id
      ...
      api = Crea::DatabaseApi.new(url: 'https://testnet.crearydev.com')
