...
module Crea
  class MarketHistoryApiTest < Crea::Test
    def setup
      @api = Crea::MarketHistoryApi.new(url: TEST_NODE)
      @jsonrpc = Jsonrpc.new(url: TEST_NODE)
      @methods = @jsonrpc.get_api_methods[@api.class.api_name]
    end
    
    def test_api_class_name
      assert_equal 'MarketHistoryApi', Crea::MarketHistoryApi::api_class_name
    end
    
    def test_inspect
      assert_equal "#<MarketHistoryApi [@chain=crea, @methods=<7 elements>]>", @api.inspect
    end
